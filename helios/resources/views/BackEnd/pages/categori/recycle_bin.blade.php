...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Quản lý danh mục (thùng rác)</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                        <li class="breadcrumb-item active">Tất cả danh mục (thùng rác)</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex justify-content-between">
                                <h3 class="card-title font-weight-bold py-2">Danh sách danh mục đã xóa</h3>
                        ...
                        <div class="card-body">
                            <table id="datatable" style="width:100%" class="display table table-bordered table-striped table-hover">
                                <thead>
                                    <tr>
                                        <th class="text-center" width="33%">Thông tin danh mục</th>
                                        <th class="text-center" width="33%">Cấp cha</th>
                                    ...
                                    @foreach ($list_category as $row)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a class="btn btn-sm btn-info mx-3" href="{{route("change_stutus_categori",["id"=>$row['id'], "status"=>2])}}"><i class="fa fa-undo"></i> Khôi phục</a>
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                Bạn có muốn xóa vĩnh viễn danh mục này không !!!
                                                            </div>
                                                            <div class="modal-footer" >
                                                                <div style="display: flex"></div>
                                                                <a class="btn btn-sm btn-success" href="{{route("destroy_categori",["id"=>$row['id']])}}">Xóa vĩnh viễn</a>
