    ...
    <div class="row">
                        ...
                        @foreach ($banner_list["left_banner"] as $item)
                            <li data-transition='slotzoom-horizontal' data-slotamount='7' data-masterspeed='1000' data-thumb='{{asset("public/images/banner/".$item->img)}}'><img src='{{asset("public/images/banner/".$item->img)}}' alt="slider image1" data-bgposition='center center' data-bgfit='cover' data-bgrepeat='no-repeat' />
                                 <div class="info">
                                    ...
                                    <div class='tp-caption sfb  tp-resizeme ' data-x='0' data-y='350' data-endspeed='500' data-speed='500' data-start='1500' data-easing='Linear.easeNone' data-splitin='none' data-splitout='none' data-elementdelay='0.1' data-endelementdelay='0.1' style='z-index:4;white-space:nowrap;'><a href='{{$item->link}}' class="buy-btn">Browse Now</a></div>
                                </div> 
                            </li>
                        @endforeach
                    </ul>
        ...
        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
            @foreach ($banner_list["right_banner"] as $item)
                <div class="banner-block"> <a href="{{$item->link}}"> <img src='{{asset("public/images/banner/".$item->img)}}' alt="" style="height:250px;width:100%"> </a>
