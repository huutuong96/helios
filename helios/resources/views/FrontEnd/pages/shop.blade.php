                  ...
                  <div id="sort-by">
                    ...
                    <ul>
                      <li><a href="#">...<span class="right-arrow"></span></a>
                        <ul>
                          <li style="width: 130px;"><a href="{{route("shop",["key"=> "price","value" => "asc"])}}">Giá tăng dần</a></li>
                          <li style="width: 130px;"><a href="{{route("shop",["key"=> "price","value" => "desc"])}}">Giá giảm dần</a></li>
                        </ul>
                      </li>
                    </ul>
                ...
                <div class="category-products">
                  <ul class="products-grid">
                    ...
                    <li class="item col-lg-4 col-md-4 col-sm-6 col-xs-6">
                        ...
                        <div class="item-img">
                            <div class="item-img-info"><a class="product-image" title="Product tilte is here" href="{{route("product_detail", ["id"=> $item->id])}}"> <img alt="Product tilte is here" src="{{asset("public/images/product/".$item->list_image[0]->image)}}"> </a>
