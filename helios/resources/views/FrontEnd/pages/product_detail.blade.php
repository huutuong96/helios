              ...
              <div class="product-img-box col-lg-4 col-sm-5 col-xs-12" style="height: 20%">
                <div class="product-image" style="height: 400px;">
                  <div class="product-full">
                    ...
                    <img id="product-zoom" style="height: 400px;" src="{{asset("public/images/product/".$product["list_img"][0]->image)}}" data-zoom-image="{{asset("public/images/product/".$product["list_img"][0]->image)}}" alt="product-image"/> </div>
                      ...
                      <div id="jtv-more-views-img" class="product-flexslider hidden-buttons product-img-thumb">
                        <div class="slider-items slider-width-col4 block-content">
                            @foreach ($product["list_img"] as $item)
                                <div class="more-views-items"> <a href="#" data-image="{{asset("public/images/product/".$item->image)}}" data-zoom-image="{{asset("public/images/product/".$item->image)}}"> <img id="product-zoom"  src="{{asset("public/images/product/".$item->image)}}" alt="product-image"/> </a></div>
                            @endforeach                          
                        </div>
                      </div>
                    </div>
                ...
                <div class="add-to-box">
                  ...
                  <div class="email-addto-box">
                    <ul class="add-to-links">
                      ...
                      <li><a class="link-compare" href="#"><i class="fa fa-signal"></i><span>danh sách so sánh</span></a></li>
                      <li><a class="email-friend" href="#"><i class="fa fa-envelope"></i><span>gủi mail liên hệ</span></a></li>
                    </ul>
                  </div>
                </div>
                <div class="social">
