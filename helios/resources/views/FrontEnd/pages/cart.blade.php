                        ...
                        <table class="shop-cart-table">
                          ...
                          <tbody>
                            ...
                            @foreach ($cart as $key => $item)
                                <tr class="cart_item">
                                    <td class="item-img"><a href="#"><img src="{{asset("public/images/product/".$item->list_image[0]->image)}}" alt="Product tilte is here "> </a></td>
          ...
          <ul class="products-grid">
            @foreach ($top_view as $item)
                <li class="item col-lg-3 col-md-3 col-sm-4 col-xs-6">
                    ...
                    <div class="item-img">
                      <div class="item-img-info"><a class="product-image" title="Product tilte is here" href="#"> <img alt="Product tilte is here" src="{{asset("public/images/product/".$item["list_img"][0]->image)}}"> </a>
