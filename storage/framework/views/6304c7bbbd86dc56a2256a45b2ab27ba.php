            ...
            <div class="card card-primary">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <img src="<?php echo e(asset("images/banner/".$banner->img)); ?>" style="width:100%" alt="">
                            </div>
                            <div class="form-group">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('BackEnd.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\du_an\laravel_web\php_3\asm\example-app\resources\views/BackEnd/pages/banner/edit_banner.blade.php ENDPATH**/ ?>