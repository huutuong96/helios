                                                    ...
                                                    <div class="carousel-inner">
                                                        <?php $__currentLoopData = $row['list_image']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <div class="carousel-item <?= ($key === 0) ? 'active' : ''; ?>">
                                                                <img src="<?php echo e(asset("public/public/images/product/". $img['image'])); ?>" class="d-block w-100" alt="Image">
                                                            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('BackEnd.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wqyksacj/public_html/helios.nguyenhuutuong.top/resources/views/BackEnd/pages/product/product_list.blade.php ENDPATH**/ ?>