                ...
                <div class="category-products">
                  <ul class="products-grid">
                    ...
                    <li class="item col-lg-4 col-md-4 col-sm-6 col-xs-6">
                        ...
                        <div class="item-img">
                            <div class="item-img-info"><a class="product-image" title="Product tilte is here" href="<?php echo e(route("product_detail", ["id"=> $item->id])); ?>"> <img alt="Product tilte is here" src="<?php echo e(asset("images/product/".$item->list_image[0]->image)); ?>"> </a>
