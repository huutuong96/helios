            ...
            <div class="slider-items-products">
              <div id="category-desc-slider" class="product-flexslider hidden-buttons">
                <div class="slider-items slider-width-col1 owl-carousel owl-theme">
                  <div class="item"> <a href="#"><img alt="New Special Collection" src="<?php echo e(asset("/")); ?>public/public/images/banner/Anh-sale-don-gian-nhung-dep.jpg" height="315px"></a>
                    <div class="cat-img-title cat-bg cat-box">
                      
                    </div>
                  </div>
                  <div class="item"> <a href="#"><img alt="New Fashion" src="<?php echo e(asset("/")); ?>public/public/images/banner/bannershop.jpg" height="315px"></a>
                    <div class="cat-img-title cat-bg cat-box">
                ...
                <div class="category-products">
                  <ul class="products-grid">
                    ...
                    <li class="item col-lg-4 col-md-4 col-sm-6 col-xs-6">
                        ...
                        <div class="item-img">
                            <div class="item-img-info"><a class="product-image" title="Product tilte is here" href="<?php echo e(route("product_detail", ["id"=> $item->id])); ?>"> <img alt="Product tilte is here" src="<?php echo e(asset("public/public/images/product/".$item->list_image[0]->image)); ?>"> </a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('FrontEnd.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wqyksacj/public_html/helios.nguyenhuutuong.top/resources/views/FrontEnd/pages/shop.blade.php ENDPATH**/ ?>