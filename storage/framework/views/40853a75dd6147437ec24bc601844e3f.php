<div class="row">
                ...
                <li class="right-space two-height item">
                    <?php $__currentLoopData = $list_product["hot_deal"]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="item-inner">
                            <div class="item-img">
                                <div class="item-img-info"><a href="<?php echo e(route("product_detail", ["id"=> $item->id])); ?>" title="Product tilte is here" class="product-image"><img src="<?php echo e(asset("public/public/images/product/". $item->list_img[0]->image)); ?>" alt="Product tilte is here"> </a>
                                </div>
    ...
    <div class="col-md-4 col-sm-6 col-xs-12 hidden-sm">
        <div class="sidebar-banner">
            <div class="jtv-top-banner"> <a href="#"> <img src="<?php echo e(asset("public/public/images/banner/".$banner_list["collection_area_top"][0]->img)); ?>" alt="banner"> </a> </div>
            <div class="jtv-top-banner"> <a href="#"> <img src="<?php echo e(asset("public/public/images/banner/".$banner_list["collection_area_buttom"][0]->img)); ?>" alt="banner"> </a> </div>
        </div>
    </div>
    <!-- Top Seller Slider -->
                                    ...
                                    <div class="item-img">
                                        <div class="item-img-info">
                                            <a class="product-image" title="Product tilte is here" href="<?php echo e(route("product_detail", ["id"=> $item->id])); ?>">
                                                <img alt="Product tilte is here" src="<?php echo e(asset("public/public/images/product/". $item->list_img[0]->image)); ?>">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="item-info">
...
</div><?php /**PATH /home/wqyksacj/public_html/helios.nguyenhuutuong.top/resources/views/FrontEnd/models/collection_area.blade.php ENDPATH**/ ?>