                                    ...
                                    <div class="col-sm-5">
                                        <div class="entry-thumb">
                                            <a href="<?php echo e(route("blog_detail", [ "id" => $item->id])); ?>">
                                                <figure><img src="<?php echo e(asset("/")); ?>public/images/post/<?php echo e($item->img); ?>" alt="Blog"></figure>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-sm-7">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('FrontEnd.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\du_an\laravel_web\php_3\asm\example-app\resources\views/FrontEnd/pages/blog.blade.php ENDPATH**/ ?>