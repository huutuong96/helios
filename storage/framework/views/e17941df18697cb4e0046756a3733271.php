...
<div class="content-wrapper">
    ...
    <section class="content">
        <form action="<?php echo e(route("creat_banner")); ?>" method="post" enctype="multipart/form-data">
            <?php echo csrf_field(); ?> 
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select id="orders" name="orders" class="form-control custom-select">
                                    <option value="left">[--- Mặc định ---]</option>
                            ...
                            <div class="form-group">
                                ...
                                <select id="position" name="position" class="form-control custom-select">
                                    <option value="slider">[--- Chọn vị trí trang chủ ---]</option>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('BackEnd.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\du_an\laravel_web\php_3\asm\example-app\resources\views/BackEnd/pages/banner/creat_banner.blade.php ENDPATH**/ ?>