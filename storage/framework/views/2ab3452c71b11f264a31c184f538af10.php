              ...
              <div class="product-img-box col-lg-4 col-sm-5 col-xs-12" style="height: 20%">
                <div class="product-image" style="height: 400px;">
                  <div class="product-full">
                    ...
                    <img id="product-zoom" style="height: 400px;" src="<?php echo e(isset($product->list_img[0]->image) ? url('public/public/images/product/' . $product->list_img[0]->image) : url('public/public/images/default.jpg')); ?>" data-zoom-image="<?php echo e(isset($product->list_img[0]->image) ? url('public/public/images/product/' . $product->list_img[0]->image) : url('public/public/images/default.jpg')); ?>" alt="product-image"/> </div>
                      ...
                      <div id="jtv-more-views-img" class="product-flexslider hidden-buttons product-img-thumb">
                        <div class="slider-items slider-width-col4 block-content">
                            <?php $__currentLoopData = $product->list_img; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="more-views-items"> <a href="#" data-image="<?php echo e(asset("public/public/images/product/".$item->image)); ?>" data-zoom-image="<?php echo e(asset("public/public/images/product/".$item->image)); ?>"> <img id="product-zoom"  src="<?php echo e(asset("public/public/images/product/".$item->image)); ?>" alt="product-image"/> </a></div>
                 ...
                 <?php else: ?> 
                    <?php $__currentLoopData = $comments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="comment" style="display: flex; margin: 5px">
                          <div class="user-img"><img src="<?php echo e(asset("public/public/images/user/".$comment->user_img ??user.jpg)); ?>" alt="" style="height: 60px; width: 60px;; border-radius: 100%"><br></div>
                    ...
                    <div class="item-img">
                        <div class="item-img-info">
                            <a class="product-image" title="Product tilte is here" href="<?php echo e(route("product_detail", ["id"=> $item->id])); ?>">
                              <img alt="Product tilte is here" src="<?php echo e(isset($item->list_img[0]->image) ? url('public/public/images/product/' . $item->list_img[0]->image) : url('images/default.jpg')); ?>"> 
                            </a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('FrontEnd.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wqyksacj/public_html/helios.nguyenhuutuong.top/resources/views/FrontEnd/pages/product_detail.blade.php ENDPATH**/ ?>