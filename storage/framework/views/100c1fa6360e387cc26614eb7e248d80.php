...
<div class="content-wrapper">
    ...
    <section class="content">
        <form action="<?php echo e(route("edit_banner")); ?>" method="post" enctype="multipart/form-data">
            <?php echo csrf_field(); ?> 
                ...
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="card-tools">
                            <input type="hidden" name="id" id="" value="<?php echo e($banner->id); ?>">
                    ...
                    <div class="row">
                        <div class="col-md-9">
                            <div class="form-group">
                                ...
                                <input type="text" id="name" name="name" class="form-control" required value="<?php echo e($banner->name); ?>">
                            </div>
                            <div class="form-group">
                                <label for="link">Đường dẫn (*)</label>
                                <input type="text" id="link" name="link" class="form-control" required value="<?php echo e($banner->link); ?>">
                            </div>
                            <div class="form-group">
                                <label for="info1">Thông tin 1: </label>
                                <input type="text" id="info1" name="info1" class="form-control" value="<?php echo e($banner->info1); ?>">
                            </div>
                            <div class="form-group">
                                <label for="info2">Thông tin 2: </label>
                                <input type="text" id="info2" name="info2" class="form-control" value="<?php echo e($banner->info2); ?>">
                            </div>
                            <div class="form-group">
                                <label for="info3">Thông tin 3: </label>
                                <input type="text" id="info3" name="info3" class="form-control" value="<?php echo e($banner->info3); ?>">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <img src="<?php echo e(asset("public/public/images/banner/".$banner->img)); ?>" style="width:100%" alt="">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select id="orders" name="orders" class="form-control custom-select">
                                    <option value="<?php echo e($banner->orders); ?>">[--- Mặc định ---]</option>
                            ...
                            <div class="form-group">
                                ...
                                <select id="position" name="position" class="form-control custom-select">
                                    <option value="slider"><?php echo e($banner->position); ?></option>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('BackEnd.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wqyksacj/public_html/helios.nguyenhuutuong.top/resources/views/BackEnd/pages/banner/edit_banner.blade.php ENDPATH**/ ?>