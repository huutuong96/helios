                                                    ...
                                                    <div class="item-img">
                                                        <div class="item-img-info">
                                                            <a class="product-image" title="" href="<?php echo e(route("product_detail", ["id"=> $item->id])); ?>">
                                                                ...
                                                                <img alt="" src="<?php echo e(isset($item->list_img[0]->image) ? url('public/public/images/product/' . $item->list_img[0]->image) : url('public/public/images/product/default.jpg')); ?>" height="250px">
                                                            </a>
                                            ...
                                            <div class="item-img">
                                                <div class="item-img-info">
                                                    <a class="product-image" title="" href="<?php echo e(route("product_detail", ["id"=> $item->id])); ?>">
                                                        ...
                                                        <img alt="" src="<?php echo e(isset($item->list_img[0]->image) ? url('public/public/images/product/' . $item->list_img[0]->image) : url('public/images/default.jpg')); ?>" height="250px">
                                                    </a>
                                    ...
                                    <div class="blog-inner">
                                        <?php $__currentLoopData = $list_post; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="col-xs-12 col-sm-4 blog-preview_item">
                                                    <div class="entry-thumb jtv-blog-img-hover"> <a href="<?php echo e(route("blog_detail", [ "id" => $item->id])); ?>"> <img alt="Blog" src="<?php echo e(asset('/')); ?>public/public/images/post/<?php echo e($item->img); ?>" height="256px"> </a> </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('FrontEnd.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wqyksacj/public_html/helios.nguyenhuutuong.top/resources/views/FrontEnd/pages/home.blade.php ENDPATH**/ ?>