                                ...
                                <div class="col-sm-12 col-md-12 col-xs-12">
                                    <div class="col-md-5">
                                        <div class="text-center">
                                            <img class="img img-fluid img-circle" style="margin-top: 15px;" height="250px" width="250px" src="<?php echo e(asset("public/public/images/user/".(Auth::user()->img ?? user.jpg))); ?>">
                                            <div>
                                            ...
                                            <div class="service-desc text-center" style="margin: 15px 0 0 30px;display:flex;width:100%">
                                                ...
                                                <img class="img-responsive" style="margin-top: -10px;width:50%;height:50%" src="<?php echo e(asset("public/public/images/member_card/".$member_rank->img)); ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-7">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('FrontEnd.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wqyksacj/public_html/helios.nguyenhuutuong.top/resources/views/FrontEnd/pages/account.blade.php ENDPATH**/ ?>