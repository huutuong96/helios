...
<div class="content-wrapper" style="padding-bottom: 100px">
    ...
    <section class="content">
        <form action="<?php echo e(route("edit_post")); ?>" method="post" enctype="multipart/form-data">
            <?php echo csrf_field(); ?> 
                    ...
                    <div class="row">
                        <div class="col-md-9">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="detail" name="detail" class="form-control summernote" rows="5"><?php echo e($post->detail); ?></textarea>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select id="status" name="status" class="form-control custom-select">
                                    <option value="<?php echo e($post->status); ?>" selected>[--- Trạng thái Bài viết ---]</option>
                            ...
                            <div class="form-group align-items-center">
                                ...
                                <div class="custom-file ">
                                    ...
                                    <label class="custom-file-label" for="img" id="img-label">Chọn nếu muốn đổi hình</label>
                                </div>
                            </div>
                            <div class="form-group align-items-center">
                                <img src="<?php echo e(asset("public/public/images/post/".$post->img)); ?>" style="width:100%" alt="">
                            </div>
                        </div>
                    </div>
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('BackEnd.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wqyksacj/public_html/helios.nguyenhuutuong.top/resources/views/BackEnd/pages/post/edit_post.blade.php ENDPATH**/ ?>