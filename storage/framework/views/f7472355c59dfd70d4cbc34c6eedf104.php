                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $list_product; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td><a href="<?php echo e(route("product_detail", ["id"=> $item->id])); ?>"><img src="<?php echo e(asset("images/product/". $item->img->image)); ?>" alt="<?php echo e($item->name); ?>" class="img-thumbnail"></a></td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('FrontEnd.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\du_an\laravel_web\php_3\asm\example-app\resources\views/FrontEnd/pages/view_orders.blade.php ENDPATH**/ ?>