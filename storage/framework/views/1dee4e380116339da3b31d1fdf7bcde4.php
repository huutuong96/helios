                        ...
                        <div class="row">
                            <div class="col-md-9">
                                ...
                                <div class="form-group row justify-content-center">
                                            <div class="col-5">
                                                <img src="<?php echo e(asset('public/images/brand/'.$brand->img)); ?>" alt="" style="height: 200px">
                                            </div>
                                </div>
                            </div>
                            <div class="col-md-3">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('BackEnd.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\du_an\laravel_web\php_3\asm\example-app\resources\views/BackEnd/pages/brand/edit_brand.blade.php ENDPATH**/ ?>