              ...
              <div class="tab-content">
                <div role="tabpanel" class="tab-pane fade in active" id="cart-conten"> 
                  ...
                  <div class="cart-page-area">
                    <form method="post" action="<?php echo e(route("update_cart")); ?>">
                      <?php echo csrf_field(); ?> 
                        ...
                        <table class="shop-cart-table">
                          ...
                          <tbody>
                            ...
                            <?php $__currentLoopData = $cart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="cart_item">
                                    <td class="item-img"><a href="#"><img src="<?php echo e(asset("public/public/images/product/".$item->list_image[0]->image)); ?>" alt="Product tilte is here "> </a></td>
                                    <td class="item-title"><a href="#"><?php echo e($item->name); ?></a></td>
                                    <td class="item-price-<?php echo e($key); ?>" > 
                                        <input type="text" name="" id="price-<?php echo e($key); ?>" value="<?php echo e(number_format($item->price_detail)); ?>" style="border: unset; background-color: unset; width:80px;height: 100%;">
                                    ...
                                    <td class="item-qty"><div class="cart-quantity">
                                        ...
                                        <div class="cart-quantity">
                                            <div class="cart-plus-minus">
                                                <div class="dec qtybutton" onClick='change_size_price(this, "-", "<?php echo e($item->price_detail); ?>", "total-price-<?php echo e($key); ?>", "<?php echo e(count($cart)); ?>")'>-</div>
                                                <input value="<?php echo e($item->number); ?>" name="number_<?php echo e($key); ?>" class="cart-plus-minus-box" type="text">
                                                <div class="inc qtybutton" onClick='change_size_price(this, "+", "<?php echo e($item->price_detail); ?>", "total-price-<?php echo e($key); ?>", "<?php echo e(count($cart)); ?>")'>+</div>
                                            </div>
                                        </div>
                                        </div>
                                    </div></td>
                                    <td class="total-price">
                                        <input type="text" name="" id="total-price-<?php echo e($key); ?>" value="<?php echo e(number_format($item->price_detail * $item->number)); ?>" style="border: unset; background-color: unset; width:80px;height: 100%;">
                                        <span style="font-size: 15px "> VND</span>
                                    </td>
                                    <td class="remove-item"><a href="<?php echo e(route("destroy_product_in_cart", ["id"=>$item->id])); ?>"><i class="fa fa-trash-o"></i></a></td>
                                </tr>
                          ...
                          <div class="col-md-8 col-sm-7 col-xs-12">
                            <div class="update-coupne-area">
                              <div class="update-continue-btn text-right">
                                ...
                                <button class="button btn-empty" title="Clear Cart" value="empty_cart" name="update_cart_action" type="buttom"><a href="<?php echo e(route("destroy_product_in_cart",["act"=>"delete_all"])); ?>">xóa hết</a></button>
                          ...
                          <div class="col-md-4 col-sm-5 col-xs-12">
                            <div class="cart-total-area">
                              ...
                              <div class="process-checkout-btn text-right">
                                <a href="<?php echo e(route("checkout")); ?>"><button class="button btn-proceed-checkout" title="Proceed to Checkout" type="button" ><span>Thanh toán</span></button></a>
                              </div>
                            </div>
                          </div>
                        </div>
      ...
      <div class="jtv-crosssel-pro">
        ...
        <div class="category-products">
          <ul class="products-grid">
            <?php $__currentLoopData = $top_view; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li class="item col-lg-3 col-md-3 col-sm-4 col-xs-6">
                    <div class="item-inner">
                    <div class="item-img">
                      <div class="item-img-info"><a class="product-image" title="Product tilte is here" href="#"> <img alt="Product tilte is here" src="<?php echo e(asset("public/public/images/product/".$item["list_img"][0]->image)); ?>"> </a>
                    ...
                    <div class="item-info">
                        ...
                        <div class="item-title"> <a title="Product tilte is here" href="#"><?php echo e($item->name); ?> </a> </div>
...
<?php $__env->startSection('js'); ?>
    ...
    <script>
       ...
       function sum_price(number) {
        ...
        sum_price(<?php echo e(count($cart)); ?>);
        
        
    </script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('FrontEnd.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wqyksacj/public_html/helios.nguyenhuutuong.top/resources/views/FrontEnd/pages/cart.blade.php ENDPATH**/ ?>