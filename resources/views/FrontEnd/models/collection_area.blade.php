<div class="row">
                ...
                <li class="right-space two-height item">
                    @foreach ($list_product["hot_deal"] as $item)
                        <div class="item-inner">
                            <div class="item-img">
                                <div class="item-img-info"><a href="{{route("product_detail", ["id"=> $item->id])}}" title="Product tilte is here" class="product-image"><img src="{{asset("public/public/images/product/". $item->list_img[0]->image)}}" alt="Product tilte is here"> </a>
                                </div>
    ...
    <div class="col-md-4 col-sm-6 col-xs-12 hidden-sm">
        <div class="sidebar-banner">
            <div class="jtv-top-banner"> <a href="#"> <img src="{{asset("public/public/images/banner/".$banner_list["collection_area_top"][0]->img)}}" alt="banner"> </a> </div>
            <div class="jtv-top-banner"> <a href="#"> <img src="{{asset("public/public/images/banner/".$banner_list["collection_area_buttom"][0]->img)}}" alt="banner"> </a> </div>
        </div>
    </div>
    <!-- Top Seller Slider -->
                                    ...
                                    <div class="item-img">
                                        <div class="item-img-info">
                                            <a class="product-image" title="Product tilte is here" href="{{route("product_detail", ["id"=> $item->id])}}">
                                                <img alt="Product tilte is here" src="{{asset("public/public/images/product/". $item->list_img[0]->image)}}">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="item-info">
