                        ...
                        <div class="my-account">
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-5 col-xs-12">
                                    <img name="current_img" class="img img-fluid img-circle" style="margin-top: 20px;margin-left:40px" height="250px" width="250px" src="{{asset("public/public/images/user/".(Auth::user()->img ?? user.jpg))}}
                                    ">
