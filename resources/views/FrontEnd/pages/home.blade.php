                                                    ...
                                                    <div class="item-img">
                                                        <div class="item-img-info">
                                                            <a class="product-image" title="" href="{{route("product_detail", ["id"=> $item->id])}}">
                                                                {{-- <img alt="" src="{{url("public/public/images/product/".$item->list_img[0]->image)}}" height="250px"> --}}
                                                                <img alt="" src="{{ isset($item->list_img[0]->image) ? url('public/public/images/product/' . $item->list_img[0]->image) : url('public/public/images/product/default.jpg') }}" height="250px">
                                                            </a>
                                        ...
                                        <div class="item-inner">
                                            <div class="item-img">
                                                <div class="item-img-info">
                                                    <a class="product-image" title="" href="{{route("product_detail", ["id"=> $item->id])}}">
                                                        {{-- <img alt="" src="{{url("public/public/images/product/".$item->list_img[0]->image)}}" height="250px"> --}}
                                                        <img alt="" src="{{ isset($item->list_img[0]->image) ? url('public/public/images/product/' . $item->list_img[0]->image) : url('public/images/default.jpg') }}" height="250px">
                                                    </a>
                                    ...
                                    <div class="blog-inner">
                                        @foreach ($list_post as $item)
                                                <div class="col-xs-12 col-sm-4 blog-preview_item">
                                                    <div class="entry-thumb jtv-blog-img-hover"> <a href="{{route("blog_detail", [ "id" => $item->id])}}"> <img alt="Blog" src="{{asset('/')}}public/public/images/post/{{$item->img}}" height="256px"> </a> </div>
                                                    <h4 class="blog-preview_title"><a href="{{route("blog_detail", [ "id" => $item->id])}}">{{$item->title}}</a></h4>
                                                    <div class="blog-preview_info">
                                                        ...
                                                        <div class="blog-preview_desc">Danh mục: {{$item->topic_name}} <a class="read_btn" href="{{route("blog_detail", [ "id" => $item->id])}}"></a></div>
                                                    </div>
                                                </div>
                                        @endforeach
                                    </div>
