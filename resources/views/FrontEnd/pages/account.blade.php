                                ...
                                <div class="col-sm-12 col-md-12 col-xs-12">
                                    <div class="col-md-5">
                                        <div class="text-center">
                                            <img class="img img-fluid img-circle" style="margin-top: 15px;" height="250px" width="250px" src="{{asset("public/public/images/user/".(Auth::user()->img ?? user.jpg))}}">
                                            <div>
                                            ...
                                            <div class="service-desc text-center" style="margin: 15px 0 0 30px;display:flex;width:100%">
                                                ...
                                                <img class="img-responsive" style="margin-top: -10px;width:50%;height:50%" src="{{asset("public/public/images/member_card/".$member_rank->img)}}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-7">
