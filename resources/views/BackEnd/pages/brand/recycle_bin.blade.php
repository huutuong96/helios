                                    ...
                                    @foreach ($list_brand as $row)
                                        <tr>
                                            <td class="text-left" style="padding-left: 50px; ">
                                                <img src="{{asset("public/public/images/brand/".$row->img)}}" style="width:100%; max-height:200px" alt="">
                                            </td>
                                            <td class="text-left" style="padding-left: 50px; ">
                                                <b>Name:</b> {{$row->name}}
                                            </td>
                                            <td class="text-center">
                                                <a class="btn btn-sm btn-info mx-3" href="{{route("change_stutus_brand",["id"=>$row->id, "status"=>2])}}"><i class="fa fa-undo"></i> Khôi phục</a>
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer" >
                                                                ...
                                                                <a class="btn btn-sm btn-success" href="{{route("destroy_brand",["id"=>$row->id])}}">Xóa vĩnh viễn</a>
