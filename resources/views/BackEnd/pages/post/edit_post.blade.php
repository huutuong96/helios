                    ...
                    <div class="row">
                        <div class="col-md-9">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="detail" name="detail" class="form-control summernote" rows="5">{{$post->detail}}</textarea>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select id="status" name="status" class="form-control custom-select">
                                    <option value="{{$post->status}}" selected>[--- Trạng thái Bài viết ---]</option>
                            ...
                            <div class="form-group align-items-center">
                                <img src="{{asset("public/public/images/post/".$post->img)}}" style="width:100%" alt="">
                            </div>
                        </div>
                    </div>
                </div>
