                        ...
                        <div class="card-header">
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="card-tools">
                                    <a class="btn btn-secondary" href="{{route("show_contact", ["idDeleted" => 0])}}">
                                    ...
                                    @foreach ($list_contact as $row)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a class="btn btn-sm btn-danger" href="{{route("change_isDeleted",["id" => $row->id])}}" style="width:80%; margin:2%"><i class="fa fa-trash"></i> Xóa</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
